...
private:
	...
	Object harvestTree{ sf::Vector2f(-1050, 75), sf::Vector2f(700, 700), sf::Color::White };
	...
	Object axeUI{ sf::Vector2f(1470, 1800), sf::Vector2f(75, 75), sf::Color::Black };
	...
	GameText woodText{ 30, sf::Color::White, sf::Text::Bold, sf::Vector2f(-950,700) };
	...
	GameText fishQuantity{ 30, sf::Color::Black, sf::Text::Bold, sf::Vector2f(-825,2040) };
